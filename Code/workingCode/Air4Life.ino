...
float workTime, rainFall, rainFall24;
int UV_dat; // , ALS_dat
int VOC;
...
void setup() {
  ...
  VOC = mySensor.getVOCindex(); // VOC index
  ...
  workTime = Sensor.getSensorWorkingTime();
  ...
  rainFall24 = Sensor.getRainfall(24); 

  delay(1000);

  // INTEGER CONVERSIONS
  int int_temp = T * 100;
  int int_relhum = RH * 100;
  int int_workTime = workTime * 100; //remove comma
  int int_rainFall = rainFall * 100;
  int int_rainFall24 = rainFall24 * 100;
  int int_temp2 = temperature * 100;
  int int_hum2 = humidity * 100;
  int int_co2 = co2Concentration * 100;

  // build payload byte array
  uint8_t uplinkPayload[18];
  uplinkPayload[0] = int_temp >> 8;
  uplinkPayload[1] = int_temp;
  uplinkPayload[2] = int_relhum >> 8;
  uplinkPayload[3] = int_relhum;
  uplinkPayload[4] = VOC;
  uplinkPayload[5] = int_workTime >> 8;
  uplinkPayload[6] = int_workTime;
  uplinkPayload[7] = int_rainFall >> 8;
  uplinkPayload[8] = int_rainFall;
  uplinkPayload[9] = int_rainFall24 >> 8;
  uplinkPayload[10] = int_rainFall24;
  uplinkPayload[11] = UV_dat;
  uplinkPayload[12] = int_temp2 >> 8;
  uplinkPayload[13] = int_temp2;
  uplinkPayload[14] = int_hum2 >> 8;
  uplinkPayload[15] = int_hum2;
  uplinkPayload[16] = int_co2 >> 8;
  uplinkPayload[17] = int_co2;
